                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a href="searchofficial.php">Search Position</a></li>
...
$sql="SELECT * FROM tblposition WHERE ID LIKE '%$sdata%' || Position LIKE  '%$sdata%' ";
$query = $dbh -> prepare($sql);
$query->execute();
...
{               ?>   
                ...
                <td><?php  echo htmlentities($row->Position);?></td>
                  ...
                  <td><a href="searchposition.php?del=<?php echo htmlentities($row->ID);?>"><button class="btn btn-danger btn-sm shadow"  data-toggle="tooltip" data-placement="top" title="Delete" style="border-radius: 4px;" onClick="return confirm('Do you really want to delete');"><span class="bi bi-trash"></span> </button></a></td>
                </tr>
                 <?php 
// $cnt=$cnt+1;
} } else { ?>
