                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a href="searchofficial.php">Search official</a></li>
...
$sql="SELECT * FROM tblofficial WHERE Name LIKE '%$sdata%' || Position LIKE  '%$sdata%' ";
$query = $dbh -> prepare($sql);
$query->execute();
...
{               ?>   
            ...
            <td><?php  echo htmlentities($row->Name);?></td>
                  ...
                  <td><a href="searchofficial.php?del=<?php echo htmlentities($row->ID);?>"><button class="btn btn-danger btn-sm shadow" data-toggle="tooltip" data-placement="top" title="Delete" style="border-radius: 4px;" onClick="return confirm('Do you really want to delete');"><span class="bi bi-trash-fill"></span></button></a></td>
                </tr>
                 <?php 
// $cnt=$cnt+1;
} } else { ?>
