...
if (strlen($_SESSION['trmsaid']==0)) {
  ...
  $chk = $dbh->prepare("SELECT Householdnumber FROM tblhousehold WHERE Householdnumber =  :householdnumber");
  $chk->bindParam(':householdnumber', $householdnumber);

  $chk->execute();

  if($chk->rowCount() > 0):

    echo '<script>alert("Household already exist !. Please try again")</script>';

    else:
    if( $query->execute() ):
   
        echo '<script>alert("Household Detail has been added.")</script>';
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a href="manage-subjects.php"> Household</a></li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <form action="searchhousehold.php" name="search" method="post"  >
                                  <div class="input-group col-4 float-right">
                                    ...
                                    <button type="button" class="btn btn-primary btn-md float-left" data-toggle="modal" data-target="#householdmodal" style="border-radius: 4px;"><span class="bi bi-plus-circle"></span>
                                        Household
                                    </button>
                            ...
                            <div class="card-body">
                                <table class="table table-hover table-striped">
                                    ...
                                    <?php
                                    $sql="SELECT * FROM tblhousehold LIMIT 5";
                                    $query = $dbh -> prepare($sql);
                                    $query->execute();
                                    ...
                                    <td><?php  echo htmlentities($row->Householdnumber);?></td>
                                    <td><?php  echo htmlentities($row->Householdhead);?></td>
                                    <td><?php  echo htmlentities($row->CreationDate);?></td>
                                
                                    <td><a href="edithousehold.php?editid=<?php echo htmlentities ($row->ID);?>" class="btn btn-success btn-sm shadow"  data-toggle="tooltip" data-placement="top" title="Edit" style="border-radius: 4px;"><span class="bi bi-pencil-square"></span> </a></td>
                                    <td><a href="household.php?del=<?php echo htmlentities($row->ID);?>"><button class="btn btn-danger btn-sm shadow" data-toggle="tooltip" data-placement="top" title="Delete" style="border-radius: 4px;" onClick="return confirm('Do you really want to delete');"><span class="bi bi-trash-fill"></span></button></a></td>
                                    </tr>
               <?php $cnt=$cnt+1;}} ?>   
    ...
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        ...
        <div class="modal-header bg-info">
          <h6 class="modal-title">New Household</h6>
        ...
        <div class="card-body card-block">
                    ...
                    <div class="card-body card-block">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="householdnumber" value="" class="form-control" id="householdnumber" required="true">
                        </div>
