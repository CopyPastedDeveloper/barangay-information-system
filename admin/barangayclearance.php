...
if (strlen($_SESSION['trmsaid']==0)) {
  ...
  $sql="INSERT INTO tblbarangayclearance (Name, Age, Puroknumber, Purpose, Issued_At, Prepared_By,Certified_By,CedulaCode,Date_Issued)VALUES(:name,:age, :purok, :purpose, :issued_at, :prepared_by, :certified_by, :cedulacode, :date_issued)";
  ...
  $chk = $dbh->prepare("SELECT  FROM tblbarangayclearance WHERE CedulaCode =  :cedulacode");
  $chk->bindParam(':cedulacode', $cedulacode);
                                ...
                                <div class="card-body">
                                    <div class="container">
                                        ...
                                        <ul class="nav nav-pills" role="tablist">
                                            <li class="nav-item">
                                            <a class="nav-link active" data-toggle="pill" href="#home"><i class="bi bi-plus-circle"></i> New Barangay Clearance</a>
                                            </li>
                                            <li class="nav-item">
                                            <a class="nav-link" data-toggle="pill" href="#menu1"><i class="bi bi-journal-richtext"></i> Barangay Clearance Records</a>
                                            </li>
                                        </ul>
                                    <hr>
                                     <!-- Tab panes -->
                                    <div class="tab-content mt-3">
                                        <!-- Start Baranagy Clearance input field section -->
                                        <div id="home" class="container tab-pane active">
                                            ...
                                            <div class="col-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="age" value="" class="form-control" id="age" required="true">
                                                </div>
                                            </div>
                                            <div class="col-4">
                                                <div class="form-group">
                                            ...
                                            <div class="col-4">
                                                ...
                                                <div class="col-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="cedulacode" value="" class="form-control" id="cedulacode" placeholder="specify CTC code number" required="true">
                                                    </div>
                                                </div>
                                                <div class="col-4">
                                                    <div class="form-group">
                                                        <label for="company" class=" form-control-label">Address Issue</label>
                                                        <input type="text" name="issued_at" value="" class="form-control" id="issued_at" placeholder="Ex. Trinidad, Tagbina Surigao del Sur " required="true">
                                                    </div>
                                                </div>
                                                <div class="col-4">
                                                    <div class="form-group">
                                                        <label for="company" class=" form-control-label">Prepared by:</label>
                                                        <input type="text" name="prepared_by" value="" class="form-control" id="prepared_by" placeholder="Secretary name " required="true">
                                                    </div>
                                                 </div>
                                                 <div class="col-4">
                                                    <div class="form-group">
                                        ...
                                        <!-- End of Barangay clearance input fields -->
                                        <!-- Start of barangay clearance record list -->
                                        <div id="menu1" class="container-fluid tab-pane fade">
                                        <form action="searchbarangayclearance.php" name="search" method="post"  >
                                            <div class="input-group col-6 float-right mb-2">
                                                ...
                                                <div class="float-left text-info"><span>Barangay Clearance List Records</span></div>                       
                                        </form> 
                                        <table class="table table-hover table-striped">
                                            ...
                                            <?php
                                            $sql="SELECT * FROM tblbarangayclearance LIMIT 5";
                                            $query = $dbh -> prepare($sql);
                                            $query->execute();
                                        ...
                                        <td><a href="issuebarangayclearance.php?editid=<?php echo htmlentities ($row->ID);?>" class="btn btn-info btn-sm shadow" data-toggle="tooltip" data-placement="top" title="Issue Clearance" style="border-radius: 4px;"><span class="bi bi-file-earmark-word"></span> </a></td>                    
                                        <td><a href="editbarangayclearance.php?editid=<?php echo htmlentities ($row->ID);?>" class="btn btn-success btn-sm shadow" data-toggle="tooltip" data-placement="top" title="Edit" style="border-radius: 4px;"><span class="bi bi-pencil-square"></span> </a></td>
