...
$propic=md5($propic).time().$extension;
 ...
 $sql="UPDATE tblresidents SET Picture=:pic WHERE ID=:eid";
        ...
        <div class="breadcrumbs">
            <div class="col-sm-4">
                <div class="page-header float-left">
                    ...
                    <h2 class="mt-1"><i class="menu-icon bi bi-people-fill text-info"></i> Residents</h2>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                ...
                <div class="col-6">
                 ...
                 <div class="col-6">
                    <div class="form-group">
                        <label for="company" class=" form-control-label">Residents Name</label>
